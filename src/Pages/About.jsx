    ...
    return (
        <div>
            <section className="bg-[#37475aff] rounded-xl rounded-b-none mt-24 text-white">
                <div className="flex flex-col mx-auto lg:flex-row">
                    ...
                    <div className="flex justify-start items-end flex-col w-full lg:w-[70%] pb-0 lg:p-5 ">
                        <div className="relative lg:-left-24">
                            <h2 className="text-5xl font-semibold playfair-display ">About Us</h2>
                ...
                <p className="w-[92%] lg:px-4 text-justify pb-10">
            ...
            <section className="bg-[#727d8d]">
                <div className="container  flex flex-col justify-center items-center lg:p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                    ...
                    <div className="flex flex-col justify-center  text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                        ...
                        <p className="mt-6 mb-8 text-lg sm:mb-12">At Book-Vite, our mission is clear: to shape the future of literature. We aim to promote literacy, empower authors, foster community, and uphold sustainability. Join us in building a world where books educate, inspire, and unite us all.</p>
                        <div>
                            <h1 className="text-2xl playfair-display">QUALITY</h1>
                            <p>At Book-Vite, quality is our cornerstone. From carefully curated books to impeccable service, we prioritize excellence in everything we do.</p>
                        </div>
                        <div>
                            <h1 className="text-2xl playfair-display">RESULTS</h1>
                            <p>At Book-Vite, we prioritize outcomes. Through strategic planning and relentless effort, we consistently deliver impactful results that drive our mission forward. With a focus on innovation and collaboration, we strive to exceed expectations and make a meaningful difference in the world.</p>
                        </div>
            ...
            <section className=" rounded-b-xl lg:p-6 bg-[#37475aff]">
                <div className="container grid gap-6 mx-auto items-center text-center lg:grid-cols-2 xl:grid-cols-5">
                    <div className="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 dark:bg-gray-50">
                        <span className="block mb-2 "></span>
                        <h1 className="text-4xl font-extrabold text-blue-600 playfair-display">Connect With Us</h1>
                        <p className="my-8 text-gray-200">
                            <span className="font-medium ">Modular and versatile.</span>Have a question or feedback? Reach out to us using the form below. We're here to help!
                        </p>
                        <form novalidate="" action="" className="self-stretch space-y-3">
                            <div>
                                <label for="name" className="text-sm sr-only">Your name</label>
                                <input id="name" type="text" placeholder="Your name" className="w-full rounded-md p-2 focus:ring focus:dark:ring-violet-600 " />
                            </div>
                            <div>
                                <label for="lastname" className="text-sm sr-only">Email address</label>
                                <input id="lastname" type="text" placeholder="Email address" className="w-full p-2 rounded-md focus:ring focus:dark:ring-violet-600 " />
                            </div>
                            <button type="button" className="w-full py-2 font-bold btn bg-blue-300">Send Massage</button>
                        </form>
                    </div>
                    <img src="https://i.ibb.co/KFs0ykY/bbbb.jpg" alt="" className="object-cover w-full rounded-md xl:col-span-3 " />
                </div>
            </section>
